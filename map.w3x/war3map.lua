...
u = BlzCreateUnitWithSkin(p, FourCC("nrat"), 15141.3, 3474.0, -49.746, FourCC("nrat"))
u = BlzCreateUnitWithSkin(p, FourCC("nrat"), 12885.3, 3333.4, -19.793, FourCC("nrat"))
...
DefineStartLocation(0, 16000.0, 1024.0)
